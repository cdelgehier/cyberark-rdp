...
pub use self::connection::{
    ClientConnector, ClientConnectorState, ConnectionResult, encode_send_data_request,
};
...
pub struct Config {
    ...
    /// Alternate shell to execute (used by CyberArk PSM and other remote app scenarios)
